...
#work(
  ...
  characteristics: (
    ...
    utvary: [
      Povídka -- kratší vypravování zaměřené na jeden hlavní děj s omezeným počtem postav a místem děje.
      Povídky obvykle končí nějakou pointou nebo morálním ponaučením.
    ],
    name-meaning: [
      Název odkazuje na hlavní postavu příběhu, Báru, jejíž povaha je, oproti ostatním dětem, velice nestandardní.
    ],
    tema: [
      Zachycení života na venkově, kritika morálky,
      pro kterou je nejdůležitější majetek a společenské postavení. Také odsuzování jedince, který vystupuje z davu.
    ],
  ),
  literary-context: (
    umelecke-smer: [
    ...
    dalsi-dila: [
      ...
      - V zámku a podzámčí -- povídka zobrazující rozdíly mezi šlechtou a poddanými
      - Pohorská vesnice -- povídka kritizující sociální poměry na venkově
      - Chyže pod horami -- povídka o životě prostých lidí v horské oblasti
    ...
    autoruv-zivot: [
      ...
      - Byla provdána za finančního respicienta (později vrchního komisaře) Josefa Němce, o patnáct let staršího než ona. Manžel byl často překládán, od svatby se stěhovali téměř každý rok. V té době se jí narodily čtyři děti.
      - V Praze se mladá a krásná Božena Němcová brzy dokonale sžila s vlasteneckou inteligencí a stýkala se téměř se všemi představiteli tehdejší české a později i slovenské kultury. K jejím přátelům patřil Havlíček, Frič, Čelakovský, Erben, Jan Evangelista Purkyně, Světlá , Podlipská , Jan Ignác Hanuš a i významní slovenští spisovatelé Samo Chalupka (1812-1883), Ján Chalupka (1791-1871), Janko Kráľ (1822-1876), Andrej Sládkovič (1820-1872)
      - Roku 1845 se rodina odstěhovala z Prahy do Domažlic, kde se Němcová věnovala národopisu, sběratelské činnosti a působila na politické uvědomění lidu.
      - Po revoluci byl J. Němec z politických důvodů přeložen do Nymburka a na podřízené místo v Liberci. V těchto letech začalo hmotné i duševní strádání Němcové, které se stále stupňovalo, až se změnilo ve skutečnou bídu celé rodiny. Ještě na konci r. 1850 byl Němec přeložen do Miškovce (později Ďarmot) v Uhrách, Němcová s dorůstajícími dětmi se odebrala do Prahy. Politický postih jejího muže pokračoval, až r. 1857 byl po několikerém dalším překládání dán do výslužby s nepatrnou penzí. Třináct let, které Němcová strávila v Praze, bylo přerušeno jen krátkým pobytem v Drážďanech a třemi cestami na Slovensko a do Uher (1851, 1852, 1855). Prakticky živila rodinu sama z nevelkých výtěžků své literární publicistické práce, někdy i z darů přátel. Napětí mezi manželi narůstalo po léta, avšak k rozchodu došlo až 1861, kdy se Němcová odstěhovala do Litomyšle, aby se na přání nakladatele Augusty ujala redakce svých spisů.
      - Na smrt nemocná a zbídačená se brzy vrátila do Prahy a 20. ledna 1862 zemřela. Její hrob je na Vyšehradě.
  ...
  kompozice: [
    - Chronologická kompozice -- příběh je vyprávěn v časovém sledu od začátku do konce bez výrazných retrospektiv nebo skoků v čase.
    - Obsahuje dialogy a monology
  ],
  obsah-dila: [
    ...
    - Společné znaky:
      - Venkov, reálná místa
        - Němcová -- báje a pověsti, Světlá -- obyčeje/svátky
      - Symboly
        - Němcová -- věneček, Světlá -- kříž
      - Hlavní postavy -- ženy
      - Námět -- boj s pomluvou
  ],
  postavy: [
    - *Bára* -- vysoká svalnatá postava, modré oči, nezávislá, statečná, drsná a v jádru citlivá. Nebojí se jít proti proudu a říct vlastní názor a pravdu.
    - *Jakub* -- nemluvný a zamračený, starý pastýř, sirotek
    - *Bářina matka* -- Bára, osaměla žena, vzala si pastýře Jakuba, měli dcerku Báru, po 2 letech zemřela na trápení
    - *Eliška* -- jemná, hezká, křehká, pritiklad Báry, kterou má ráda a dělí se s ní o svůj život
    - *Jozífek* -- kamarád Báry a Elišky, malý slabý hoch, ostatní hoši ho šikanují, Bára ho brání
    - *Pes Lišaj* -- věrný pes Báry, její nejlepší kamarád a společník. Oddaný.
    - *Myslivec* -- tajně zamilovaný do Báry.
  ],
  vypravecsky-zpusob: [
    - Vyprávěno v er-formě
    - Obsahuje dialogy, přímou řeč
  ],
  jazyk-dila: [
    - Spisovný jazyk s neutrálními, odbornými i knižními prvky
    - Obsahuje i prvky nespisovné češtiny s hanlivými či archaistickými výrazy
    - Obsahuje mnoho uměleckých prostředků:
      - přirovnání -- "Hrubé jako žíně"
      - metafora -- "Život plyne jako luční potok"
      - metonymie -- "pěknými slovy oči zasypat"
      ...
      - inverze -- "přala si ještě syna mít, by lépe dívat se mohla"
  ],
  ohlas-dila: [
    - Díla jsou pozitivně hodnocena jak kritiky tak čtenáři
    - Němcovou považujeme za největší současnou českou spisovatelku
    - Úspěch kontrastuje s jejím těžkým životem plným osobních tragédií

    - Vznikly filmové adaptace, divadelní hry, či opery
    - Erben si například velice cenil práce Němcové
  ],
  ctenar: [
    Řekl bych, že její díla femnisticky vyčnívají -- nemá ráda tehdejší standardy a chtěl pozvednout schopnosti žen. Také neměla ráda, jakou autoritu měl manžel nad ženou.

    Viz #link("https://rozbor-dila.cz/diva-bara-rozbor-dila-k-maturite/"), za mě hezký rozbor
  ],
)